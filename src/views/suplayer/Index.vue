                                        ...
                                        <tr v-for="(suplayer, index) in list_data_suplayer.data" :key="index">
                                            ...
                                            <td class="align-middle">
                                                <div class="btn-group float-lg-end mt-2">
                                                    <button class="btn btn-sm btn-success mb-2"  @click.prevent="edit(suplayer.id, index)">
                                                        <i class="fas fa-highlighter fa-sm text-white-50"></i> Edit
                                                    </button>
                                                    <button class="btn btn-sm btn-danger mb-2" @click.prevent="confirmDelete(suplayer.id, index)">
